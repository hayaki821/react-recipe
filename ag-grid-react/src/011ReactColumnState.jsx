...
function ReactColumnState() {
  ...
  const onGroupViaApi = useCallback(() => {
    gridRef.current.columnApi.setRowGroupColumns(['country', 'athlete']);
    gridRef.current.columnApi.setColumnsVisible(['country', 'athlete'], false);
    ...
    gridRef.current.columnApi.setColumnAggFunc('silver', 'sum');
    gridRef.current.columnApi.setColumnAggFunc('bronze', 'sum');
    gridRef.current.columnApi.setColumnAggFunc('gold', 'sum');
    gridRef.current.columnApi.setColumnAggFunc('total', 'sum');
  }, []);
...
export default ReactColumnState;
